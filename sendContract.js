...
let constractAddr="0xEDA301E29EAe326F5DF125b8573f6a8Dd7865E29"//arguments[0];
let toAddr="0xdb24e23e49cfc7c3cf15be02461387a060284964"//arguments[1];
...
web3.eth.getAccounts().then(function(value){
   ...
   //let contract = new web3.eth.Contract(abi);
    ...
    contract.options.address = constractAddr;
